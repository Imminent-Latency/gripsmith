...
| **A11** | Winding convention. Every exported outer ring **with non-zero area** has positive signed area; every such hole ring negative. Zero-area rings (the preserved figure-eight) have no winding to enforce and pass through unchanged — see A12a. |
